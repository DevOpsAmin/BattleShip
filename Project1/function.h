...
void WinnerPlayer() {
	system("cls");
	bool b = PlaySound(TEXT("Super-Mario-Bros.-Level-Complete-Soundtrack-Sound-Effect-for-editing.wav"), NULL, SND_ASYNC);
	Show_Text("        *     *     * * *     *     *               ", 3);
	Show_Text("         *   *     *     *    *     *               ", 3);
	Show_Text("           *       *     *    *     *               ", 3);
	Show_Text("           *       *     *    *     *               ", 3);
...
void welcomeScreen() {
	bool b = PlaySound(TEXT("Fena-Halde-Gaza-Getiren-Efsane-Şarkı.wav"), NULL, SND_ASYNC);
	...
	mysetcolor(4, 0);
	Show_Text("        *      * * * *      *     *         *             *         * * * * *     * * * * *         *", 3);
	Show_Text("        *                ________________________________________________________                   *", 3);
	Show_Text("        *               |                                                        |                  *", 3);
	Show_Text("        *               |           * * * *   *     *    *    * * * *            |                  *", 3);
	Show_Text("        *               |           *         *     *         *     *            |                  *", 3);
	mysetcolor(2, 0);
